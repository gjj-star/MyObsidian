...
**英文**：Enterprise Resource Planning（ERP，企业资源计划）；Customer Relationship Management（CRM，客户关系管理）；Human Resource Management（HRM，人力资源管理）

## 要点/分类：一句话区分

| 系统 | 管什么 | 面向谁 | 核心问题 |
|------|--------|--------|---------|
| **ERP** | 企业**内部资源**（钱、物、产能） | 财务/采购/生产/仓库 | "钱花哪了？货在哪？产能够不够？" |
| **CRM** | 企业**外部关系**（客户、商机） | 销售/市场/客服 | "谁可能买？跟到哪步了？签了之后有没有流失风险？" |
| **HRM** | 企业**人力资源**（人、能力） | HR/管理者/员工 | "多少人？花了多少工资？绩效好不好？关键岗位有没有备胎？" |
...
- **HRM 和 OA 考勤模块有重叠**：OA 管审批流（请假申请），HRM 管余额计算（还剩几天年假）和薪资关联（扣多少钱）——两者通过接口同步。详见 [[HRM 人力资源管理]]
...
FDE（Field Deployment Engineer，前线部署工程师）的核心工作就是打通这四层之间的数据流。

**Why:** 郭锦佳在 AIBP 业财实习中接触的就是 ERP 财务模块，理解 ERP↔CRM↔HRM↔OA 的全局关系是 FDE 的基础素养——客户问"这个系统能不能跟我们的 X 对接"，要知道 X 是什么、数据流向哪。

**How to apply:** 面试中遇到"你了解企业软件吗"用三句话框架回答；实施时用联动场景判断集成边界；与 [[OA 系统概述]]、[[HRM 人力资源管理]]、[[FDE 职业知识卡]] 配合使用。

## 相关

- [[数字孪生 Digital Twin]] — 企业数字化从管理软件向实时镜像演进的新形态
- [[B 端与 C 端 B2B B2C]] — 三者均为典型 B 端系统
