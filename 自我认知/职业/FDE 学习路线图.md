...
**英文**：FDE（Frontline Deployment Engineer，前线部署工程师）；SA（Solutions Architect，解决方案架构师）；CSE（Customer Success Engineer，客户成功工程师）；TAM（Technical Account Manager，技术客户经理）

让产品在客户真实环境里跑起来的人。一半工程师 + 一半现场顾问。代表公司：Palantir。
核心能力：写代码 + 读代码 + 调试生产环境 + 搞定客户。

> 详见 [[PM 与 FDE 对比]] 中的定义与对比。
...
| 岗位 | 匹配度 | 说明 |
|------|--------|------|
| 解决方案工程师/SA | 5/5 | 技术+沟通，FDE 最接近的国内岗位 |
| 交付工程师 | 4/5 | 数据迁移+环境部署，直接对应 |
| 客户成功工程师/CSE | 4/5 | 偏持续运营，技术要求稍低 |
| 技术顾问（实施方向） | 3/5 | 业财/SaaS 领域直接对口 |
| TAM | 3/5 | 偏关系维护+技术协调，沟通要求高 |
| DevRel/Developer Advocate | 2/5 | 偏社区，外向型工程师 |
...
- [[FDE 职业知识卡]] — FDE 职业概念与能力模型
- [[PM 与 FDE 对比]] — 定义与对比
- [[OA 与 FDE 岗位的关系]] — 国内 OA 行业中的 FDE 岗位
- [[BOSS 直聘避坑指南]] — 求职落地时的避坑参考
- [[内网穿透 NAT Tunneling]] — 客户内网环境的访问技术
