...
[![Archify product preview](https://github.com/tt-a1i/archify/raw/main/docs/assets/archify-readme-hero.png)](https://github.com/tt-a1i/archify/blob/main/docs/assets/archify-readme-hero.png)
...
**Current stable version:** `v2.13.0`. See [Changelog](https://github.com/tt-a1i/archify/blob/main/CHANGELOG.md#2130--2026-08-03).
...
[![APINEBULA — One API for leading AI models](https://github.com/tt-a1i/archify/raw/main/docs/assets/sponsors/apinebula-archify.jpg)](https://apinebula.ai/ref/wywnaATT)
...
[![Archify × Raven — Map the system. Keep the context.](https://github.com/tt-a1i/archify/raw/main/docs/assets/sponsors/evermind-archify-raven.png)](https://github.com/EverMind-AI/Raven)
...
![Three verified Archify artifacts moving through Signal Flow, Blueprint, and Classic presets](https://github.com/tt-a1i/archify/raw/main/docs/assets/archify-live-proof.gif)
...
[![MCO runtime architecture generated from the public mco-org/mco repository](https://github.com/tt-a1i/archify/raw/main/docs/assets/mco-runtime-share-card.png)](https://tt-a1i.github.io/archify/cases/mco-runtime.architecture.html?theme=dark&present=1#view=dispatch-path)
...
| Dark | Light |
| --- | --- |
| [![Dark theme](https://github.com/tt-a1i/archify/raw/main/docs/assets/archify-dark.png)](https://github.com/tt-a1i/archify/blob/main/docs/assets/archify-dark.png) | [![Light theme](https://github.com/tt-a1i/archify/raw/main/docs/assets/archify-light.png)](https://github.com/tt-a1i/archify/blob/main/docs/assets/archify-light.png) |

The Export menu copies PNG to the clipboard and downloads static or motion formats:

[![Export menu](https://github.com/tt-a1i/archify/raw/main/docs/assets/archify-menu.png)](https://github.com/tt-a1i/archify/blob/main/docs/assets/archify-menu.png)
...
[![Route Share Card showing the exact Users to API Server path with the full architecture retained as context](https://github.com/tt-a1i/archify/raw/main/docs/assets/archify-route-share-card.png)](https://github.com/tt-a1i/archify/blob/main/docs/assets/archify-route-share-card.png)
...
[![MCO downstream Reach Share Card showing authored relationships from Command Router](https://github.com/tt-a1i/archify/raw/main/docs/assets/mco-runtime-reach-share-card.png)](https://github.com/tt-a1i/archify/blob/main/docs/assets/mco-runtime-reach-share-card.png)
...
[![Architecture Delta showing added, removed, changed, and moved authored facts](https://github.com/tt-a1i/archify/raw/main/docs/assets/architecture-delta-proof.jpg)](https://github.com/tt-a1i/archify/blob/main/examples/checkout-platform-delta.html)
...
[![Workflow example](https://github.com/tt-a1i/archify/raw/main/docs/assets/archify-workflow.png)](https://github.com/tt-a1i/archify/blob/main/docs/assets/archify-workflow.png)

Sequence explains one interaction over time:

[![Sequence example](https://github.com/tt-a1i/archify/raw/main/docs/assets/archify-sequence.png)](https://github.com/tt-a1i/archify/blob/main/docs/assets/archify-sequence.png)

Data Flow makes movement and sensitivity boundaries explicit:

[![Data Flow example](https://github.com/tt-a1i/archify/raw/main/docs/assets/archify-dataflow.png)](https://github.com/tt-a1i/archify/blob/main/docs/assets/archify-dataflow.png)

Lifecycle separates progress, waits, retries, and terminal outcomes:

[![Lifecycle example](https://github.com/tt-a1i/archify/raw/main/docs/assets/archify-lifecycle.png)](https://github.com/tt-a1i/archify/blob/main/docs/assets/archify-lifecycle.png)
